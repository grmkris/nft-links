...
import {RewardProgramTable} from "../../../components/reward-program/RewardProgramTable";
    ...
    <div className="card card-side m-4 rounded-xl bg-base-300 shadow-xl">
      ...
      <div className="card-body">
        <h2 className="card-title">
          Your <span className="text-primary-focus underline underline-offset-2">Reward programs</span>{' '}
        </h2>
