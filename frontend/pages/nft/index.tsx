  ...
  return (
    <Layout>
      <div className="bg-gray-100 py-2">
        <div className="my-4 mx-2 flex flex-col space-y-3 rounded-xl bg-white py-4 shadow-xl shadow-secondary/5 md:mx-10">
          <div className="px-5 text-center text-lg text-gray-700 sm:px-12 sm:text-left sm:text-2xl md:text-4xl">
            <p>
          ...
          <div className="flex flex-col justify-between divide-y px-2 text-xl sm:flex-row sm:divide-y-0 md:px-12 ">
            ...
            <div className="flex flex-col py-2 text-center">
              <div className="text-sm text-black md:text-2xl">Total NFT&apos;s</div>
