...
function CreateNFTHeader() {
  ...
  return (
    <div className="py-4 text-black md:px-12">
      <div className="flex w-full flex-col items-center justify-between rounded-lg bg-white  p-5 px-8 md:flex-row">
        ...
        <div className="mt-4 flex w-full flex-col justify-around space-y-3 text-center text-lg text-gray-600 md:mt-0 md:w-3/4 md:flex-row md:space-x-4 md:space-y-0">
          <Link href="/nft/info" passHref>
            <div
              className={`rounded-lg md:w-1/3 ${
                router.pathname == '/nft/info' ? 'bg-slate-200 text-cyan-400' : ''
          ...
          <Link href="/nft/contract" passHref>
            <div
              className={`rounded-lg md:w-1/3   ${
                router.pathname == '/nft/contract' ? 'bg-slate-200 text-cyan-400' : ''
              } py-1 hover:bg-slate-300 hover:text-cyan-400`}
            >
