...
export const GroupsModal = (props: {
  ...
  return (
    <>
      <label htmlFor='groups-modal' className='btn btn-primary'>
        {props.group ? (
      ...
      <input type='checkbox' id='groups-modal' className='modal-toggle' />
        ...
        <div className='modal-box'>
          ...
          <form className={'form-control'} onSubmit={handleSubmit}>
            ...
            <div className='modal-action'>
              <label htmlFor='groups-modal' className='btn btn-secondary'>
                Close
              </label>
              <button
                data-dismiss='groups-modal'
