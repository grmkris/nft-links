    ...
    <div className="grid h-1/3 grid-cols-1 md:h-screen md:grid-cols-3 md:space-x-2 ">
      ...
      <div className="col-span-2">
        <div className="flex flex-col items-center justify-center bg-white p-5 dark:bg-slate-800">
          <div
            className="w-full rounded-xl bg-gray-100 p-5 text-sm shadow-lg shadow-gray-200 dark:bg-gray-700 dark:shadow-gray-700 md:text-base lg:order-2">
          ...
          <div
            className="mt-8 flex min-w-fit  flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-4 sm:px-16 sm:py-4 md:px-8 lg:order-1  ">
            <UserProvider
